...
if flag_settarget:
    ...
    #                      [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]]
    #Target COIL
    m_change_robot2ref_target1 =[[ 8.16063092e-01,  5.75571507e-01,  5.25211270e-02,  3.31390502e+01],
                                [ 4.54597142e-01, -5.83103044e-01, -6.73299546e-01,  1.85120609e+02],
                                [-3.56906806e-01,  5.73330864e-01, -7.37502035e-01, -5.91624170e+00],
                                [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]]

    m_change_robot2ref_target2 =[[ 8.62966838e-01,  4.45601271e-01,  2.38175865e-01,  2.21997359e+02],
                                [ 4.69741761e-01, -5.33949494e-01, -7.03022486e-01,  1.99343330e+02],
                                [-1.86093830e-01,  7.18566242e-01, -6.70098233e-01,  1.25692816e+01],
                                [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]]
...
#     print('coord',coord)
    ...
    if i < 100:
        ...
        m_robot_new1 = M_ref_tracker_in_robot @ m_change_robot2ref_target1
    ...
    if flag_plot:
        ...
        plot_basis(ax, M_ref_tracker_in_robot[:3, :3], M_ref_tracker_in_robot[:3, 3], s=100)
        plot_basis(ax, m_robot[:3, :3], m_robot[:3, 3], s=100)
        plot_basis(ax, m_robot_new[:3, :3], m_robot_new[:3, 3], s=100)
        ax.set_xlim([-100, 800])
        ax.set_ylim([-300, 800])
        ax.set_zlim([-300, 700])
